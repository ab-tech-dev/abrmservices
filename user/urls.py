...
from .views import mydashboard, delete_listing, get_listing_data, chat_list, chat_detail, send_message, initiate_chat,notifications_page,mark_as_read,delete_notification
urlpatterns = [
    ...
    path('initiate_chat/<str:email>/', initiate_chat, name='initiate_chat'),
